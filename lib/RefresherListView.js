...
class RefresherListView extends React.Component {
    ...
    updateUIThreshold(threshold) {
        ...
        this.requestAnimationFrame(() => {
            ...
            listviewscroll.setNativeProps({contentInset:{top:threshold}});
            listviewscroll.refs.InnerScrollView.setNativeProps({paddingTop:threshold});
            listview.setNativeProps({top:-threshold,bottom:0});
        });
    }
